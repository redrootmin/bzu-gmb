...
tput setaf 2; echo "Установка Natron - бесплатной профессиональной программы с открытым исходным кодом, основанной на узлах (node-based) и предназначенная для видеокомпозитинга [https://natrongithub.github.io/ , уроки:https://www.youtube.com/user/MsAlexWorldwide/videos]. Версия скрипта 1.0b, автор: Яцына М.А."
tput sgr0
