...
tput setaf 2; echo "Установка утилиты gdebi [https://launchpad.net/gdebi]. Версия скрипта 1.0, автор: Яцына М.А."
tput sgr0

#запуск основных команд модуля
echo "${pass_user}" | sudo -S apt install -f -y --reinstall gdebi gdebi-core || let "error += 1"
...
gdebi & sleep 5;echo "${pass_user}" | sudo -S killall gdebi
