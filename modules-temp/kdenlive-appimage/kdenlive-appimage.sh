...
name_app_folder="kdenlive-appimage"
name_app_arhive="kdenlive-appimage-21-12-3.tar.xz"
name_script_start="kdenlive-appimage-starter.sh"
name_pack_apps="v1"
...
tput setaf 2; echo "Установка Kdenlive  нелинейного видеоредактора с открытым исходным кодом [https://kdenlive.org/]. Установка Kdenlive производиться в формате Appimage. Версия скрипта 1b, автор: Яцына М.А."
tput sgr0
