...
tput setaf 2; echo "Установка Blender[2-93-7]portable - программное обеспечение для создания трёхмерной компьютерной графики [https://www.blender.org/]. Установка Blender осуществлыется в формате Portable. Версия скрипта 1.0b, автор: Яцына М.А."
tput sgr0
...
if [ -e "/home/${user_run_script}/blender[2-93-7]portable/app/blender" ]
then
...
tput sgr0
cd
name_app_folder="blender[2-93-7]portable"
name_app_arhive="blender.2-93-7.portable.tar.xz"
name_script_start="blender_starter.sh"
rm -f ${name_app_arhive}
wget https://github.com/redrootmin/bzu-gmb-modules/releases/download/v1/blender.2-93-7.portable.tar.xz
