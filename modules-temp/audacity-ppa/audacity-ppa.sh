...
tput setaf 2; echo "Установка Audacity свободного многоплатформенного аудиоредактора звуковых файлов [https://www.audacityteam.org/]. Установка Audacity осуществлыется через оригинальный репозиторий программы. Версия скрипта 1.0, автор: Яцына М.А."
tput sgr0
...
audacity & sleep 5;echo "${pass_user}" | sudo -S killall audacity
