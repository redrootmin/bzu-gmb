...
tput setaf 2; echo "Установка Audacity свободного многоплатформенного аудиоредактора звуковых файлов [https://www.audacityteam.org/]. Установка Audacity осуществлыется через офицальный репозиторий Ubuntu. Версия скрипта 1.0, автор: Яцына М.А."
tput sgr0
